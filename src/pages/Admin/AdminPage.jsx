...
const stats = [
  { name: '국민취업지원제도 참여현황(월)', value: '$405,091.00', change: '+4.75%', changeType: 'positive' },
]
...
export default function AdminPage() {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center w-1/2 h-1/2 mt-2 mb-4">
        <input
          type="text"
          name="search"
          id="search"
          ...
          />
        <div className="items-center justify-center inset-y-0 right-0 flex py-1.5 pr-1.5">
            <p className="inline-flex rounded px-1 font-sans text-xs text-gray-400">
            감독을 원하는 강좌를 검색하세요.
            </p>
          <kbd className="inline-flex items-center rounded border border-gray-200 px-1 font-sans text-xs text-gray-400">
            ...
            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              <h1 className="text-base font-semibold leading-7 text-gray-900">국비교육 통계 한눈에 보기</h1>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
              <div className="flex items-center justify-between">
                <h2 className="text-base font-semibold leading-7 text-gray-900">New</h2>
